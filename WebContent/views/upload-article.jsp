...
<div class="hero-unit " id="container">
	<form class="form" action="../UploadArticle" method="post"
		...
		<div>
			...
			<div class="input-prepend"
				...
				<span class="add-on"><i class="icon-user"></i></span> <input
					type="text" size="30" name="firstname" value="" placeholder="your firstname" />
			</div>
		</div>
		<div>
			<div style="width: 200px; display: inline-block">
		...
		<div>
			...
			<div class="input-prepend"
				...
				<span class="add-on"><i class="icon-pencil"></i></span> <input
					type="text" size="30" name="title" value="" placeholder="Title" />
			</div>
		</div>
		<div>
			<div style="width: 200px; display: inline-block">
			...
			<div style="width: 250px; display: inline-block">
				<textarea rows="10" cols="25" name="abstract"
					placeholder="Enter Maximum 250 words seperated by comma"></textarea>
			</div>
		</div>
		...
		<div>
			...
			<div class="input-prepend"
				style="width: 250px; display: inline-block">
				<span class="add-on"><i class="icon-pencil"></i></span> <input
					type="text" size="30" name="keywords" value=""
