...
function addAuthor() {
  ...
  $('.authors').append('<div class="input-prepend"><span class="add-on"><i class="icon-user"></i></span>First name:<input type="text" id="'+numberOfFirstname+'" placeholder="Firstname" value="" name="f'+numberOfFirstname+'"><br><div class="input-prepend"><span class="add-on"><i class="icon-user"></i></span>Last name:<input type="text" value="" id="'+numberOfLastname+'" placeholder="Lastname" name="la'+numberOfLastname+'" /><br><div class="input-prepend"><span class="add-on"><i class="icon-envelope"></i></span>Email:<input type="text" value="" id="'+numberOfEmail+'" placeholder="Email" name="e'+numberOfEmail+'" />');
